// path: src/components/DecryptedText/DecryptedText.jsx
import { useEffect, useState, useRef } from 'react';
import { motion } from 'framer-motion'; // was 'motion/react'

/**
 * DecryptedText
 * Displays a scrambling/decrypting text effect.
 * Note: Requires 'framer-motion' (or swap to Motion One and adjust import).
 */
const styles = {
...
export default function DecryptedText({
  ...
  return (
    <motion.span
      ...
      {...hoverProps}
      {...props}
      initial={{ opacity: 0 }}        // why: basic visual confirmation that framer-motion is wired
      animate={{ opacity: 1 }}
